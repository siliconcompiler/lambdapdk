...
add_pdn_stripe -grid {grid} -layer {met4} -width {1.600} -pitch $met4_pitch -offset [expr {$met4_pitch / 4}]
add_pdn_stripe -grid {grid} -layer {met5} -width {1.600} -pitch $met5_pitch -offset [expr {$met5_pitch / 4}]
