...
def setup(chip):
    ...
    # model files
    lib.add('output', 'slow', 'nldm', libdir + '/nldm/sky130_fd_sc_hd__ss_n40C_1v40.lib.gz')
    lib.add('output', 'typical', 'nldm', libdir + '/nldm/sky130_fd_sc_hd__tt_025C_1v80.lib.gz')
    lib.add('output', 'fast', 'nldm', libdir + '/nldm/sky130_fd_sc_hd__ff_100C_1v95.lib.gz')
