...
module la_clkmux2(clk0, clk1, sel0, sel1, nreset, out);
  ...
  NAND2x1_ASAP7_75t_R _10_ (
    .A(_00_),
    .B(sel0),
    .Y(\ienb.z )
  );
  INVx2_ASAP7_75t_R _11_ (
    .A(\iensync.z ),
    .Y(_04_)
  );
  ...
  TIELOx1_ASAP7_75t_R _14_ (
    .L(_05_)
  );
  ASYNC_DFFHx1_ASAP7_75t_R \iensync.a_$_DFF_PN0__Q  (
    .CLK(clk0),
  ...
  ASYNC_DFFHx1_ASAP7_75t_R \igate[1].en_$_DFF_PN0__Q  (
    .CLK(clk1),
  ...
  ASYNC_DFFHx1_ASAP7_75t_R \isync[0].shiftreg_$_DFF_PN0__Q  (
    .CLK(clk0),
    .D(\ienb.z ),
    .QN(_02_),
    .RESET(_03_),
  ...
  ASYNC_DFFHx1_ASAP7_75t_R \isync[1].shiftreg_$_DFF_PN0__Q  (
    .CLK(clk1),
    .D(\isel[1].z ),
    .QN(_01_),
    .RESET(_03_),
