...
####################################
define_pdn_grid -name {fakeram45} -voltage_domains {CORE} -macro -orient {R0 R180 MX MY} -halo {2.0 2.0 2.0 2.0} -cells {fakeram45_.*}
...
# grid for: fakeram45_rotated
####################################
define_pdn_grid -name {fakeram45_rotated} -voltage_domains {CORE} -macro -orient {R90 R270 MXR90 MYR90} -halo {2.0 2.0 2.0 2.0} -cells {fakeram45_.*}
